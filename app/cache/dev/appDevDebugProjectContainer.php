...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'database_host' => 'victorbarcelo.net',
            'database_port' => NULL,
            'database_name' => 'victorba_igni941',
            'database_user' => 'victorba_igni941',
            'database_password' => 'f(hP6(92S5',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'victorbarcelo.net',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'es',
            'secret' => 'jhdlkjahsdlkjhaskljfhaskljfhaks',
            'cw_database_driver' => 'pdo_mysql',
            'cw_database_host' => 'victorbarcelo.net',
            'cw_database_port' => NULL,
            'cw_database_name' => 'victorba_igni941',
            'cw_database_user' => 'victorba_igni941',
            'cw_database_password' => 'f(hP6(92S5',
            ...
            'kernel.secret' => 'jhdlkjahsdlkjhaskljfhaskljfhaks',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'victorbarcelo.net',
            ...
            'endroid.twitter.consumer_key' => 'r29pd1H172kd31vDqS5XKlgiw',
            'endroid.twitter.consumer_secret' => 'NieNYkiEpCdZ9ByAdjCFZG1ayhiK7Oj8yanzz4wLb1dY2h74To',
    ...
    {
        return $this->services['endroid.twitter'] = new \Endroid\Twitter\Twitter('r29pd1H172kd31vDqS5XKlgiw', 'NieNYkiEpCdZ9ByAdjCFZG1ayhiK7Oj8yanzz4wLb1dY2h74To', '2881863592-iAQEp0OnHq6Q9Anu47ZRCnBbMjJuHXLUgdcTFyT', 'Qqf4Z8uyRjevU3KYFEewsqLghvZRotGsIy3m3vlrTFnxU', NULL);
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'Vbv\\PistatsBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/modal/user-admin');
        ...
        $n->setOptions(array('login_path' => '/login', 'default_target_path' => '/', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $instance->setHost('victorbarcelo.net');
        $instance->setPort(25);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Vbv/PistatsBundle/Resources/views'), 'VbvPistats');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('jhdlkjahsdlkjhaskljfhaskljfhaks');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.user_db'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'VbvPistatsBundle:User', 'username', NULL);
    }
