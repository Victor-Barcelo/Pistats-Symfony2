 ...
 */
class Temperature extends \Vbv\PistatsBundle\Entity\Temperature implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vbv\\PistatsBundle\\Entity\\Temperature' . "\0" . 'id', '' . "\0" . 'Vbv\\PistatsBundle\\Entity\\Temperature' . "\0" . 'temperature', '' . "\0" . 'Vbv\\PistatsBundle\\Entity\\Temperature' . "\0" . 'time');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Temperature $proxy) {
